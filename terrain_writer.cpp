...
void TerrainWriter::readAllPointsFromFile(std::map<std::array<int, 2>, TerrainPoint>& loaded_map) {
	readAllPointsFromFile(point_file.get(), loaded_map);
}

void TerrainWriter::writeAllPointsToFile(const std::map<std::array<int, 2>, TerrainPoint>& loaded_map) {
	writeAllPointsToFile(point_file.get(), loaded_map);
}
...
void TerrainWriter::readAllPointsFromFile(std::fstream* fs, std::map<std::array<int, 2>, TerrainPoint>& points) {
...
void TerrainWriter::readPointsFromFile(std::fstream* fs, std::map<std::array<int, 2>, TerrainPoint>& points, int num_points) {
